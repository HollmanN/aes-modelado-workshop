...
public class ObjectFactory {
    ...
    private final static QName _PagoResource_QNAME = new QName("http://www.servicios.co/pagos/schemas", "PagoResource");
    ...
    public JAXBElement<Pago> createPagoResource(Pago value) {
        return new JAXBElement<Pago>(_PagoResource_QNAME, Pago.class, null, value);
    }
